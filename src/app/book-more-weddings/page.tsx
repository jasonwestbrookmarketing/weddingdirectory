...
export default function BookMoreWeddingsPage() {
  return (
    <>
      ...
      <section
        className="relative bg-white pt-3 lg:pt-0 flex flex-col lg:block lg:-mt-[92px] lg:items-center lg:overflow-hidden flex-1 lg:flex-none bmw-hero"
      >
      ...
      <section className="bg-stone-50/70 py-20 sm:py-28 border-b border-stone-200/60">
        <div className="max-w-5xl mx-auto px-6 md:px-10">
          ...
          >
            ...
            <HighlighterText>So Why Are They Still Booking Somewhere Else?</HighlighterText>
          </h2>
          <div
