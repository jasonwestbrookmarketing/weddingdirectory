...
export const metadata: Metadata = {
  ...
  description:
    "List your venue free and get found by couples actively searching for a place to get married. Live in minutes.",
...
export default function FreeListingPage() {
  return (
    <>
      ...
      <section className="relative bg-white overflow-hidden lg:pt-16 lg:pb-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 -mt-8 lg:mt-0 pb-12 lg:pb-0 grid lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            >
              Join The Fastest Growing Wedding Directory
            </h1>
      ...
      {/* Shared sales body with free-listing variant */}
      <BrideBookingSections trialHref={LISTING_HREF} variant="free-listing" />
