...
export default function StrategyCallModal() {
  ...
  // Exit-intent + mobile dwell. ExitIntent.tsx also fires open-strategy-modal
  // on desktop mouseleave; this is the fallback for the modal's own timer
  // and for cases where the visitor already has the page open.
  useEffect(() => {
