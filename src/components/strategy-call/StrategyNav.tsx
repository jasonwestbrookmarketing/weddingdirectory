  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-5 md:px-10 py-3 lg:py-4">
        ...
        <a
          href={BOOKING_URL}
          className="inline-flex items-center justify-center gap-2 rounded-full bg-[#1a1a1a] text-white text-[13px] sm:text-sm font-semibold px-4 sm:px-5 py-2 sm:py-2.5 hover:-translate-y-px hover:shadow-[0_8px_24px_-8px_rgba(0,0,0,0.35)] active:scale-[0.98] transition-all"
