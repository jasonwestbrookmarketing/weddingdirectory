...
export default function PhonePreview({
  ...
  return (
    <div className="relative flex justify-center">
      {/* Floating badge — same for both modes */}
      ...
      {/*
       * Identical phone shell for both modes — same outer dimensions,
       * same stone-900 bezel, same shadow, same dynamic island as the hero.
       */}
      <div
